 ...
 */
export function generateToken(payload: Record<string, any>, expiresInMs: number = DEFAULT_EXP_MS): string {
 ...
 */
export function verifyToken(token: string): { valid: true; payload: any } | { valid: false; reason: string } {
