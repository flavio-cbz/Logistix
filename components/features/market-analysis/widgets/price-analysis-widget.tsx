...
export default memo(function PriceAnalysisWidget(
  { analysis }: Readonly<PriceAnalysisWidgetProps>
) {
  ...
  }, [analysis?.avgPrice, analysis?.priceRange?.min, analysis?.priceRange?.max])
          ...
          <div className="text-sm text-muted-foreground">
            {isAvgBelowMidpoint ? (
              ...
              <div className="flex items-center gap-2 text-[hsl(var(--warning-foreground))]">
                <TrendingDown className="h-4 w-4" aria-hidden="true" focusable="false" />
                <span>
