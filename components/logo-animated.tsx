...
export function LogoAnimated() {
  return (
    ...
    >
      <div
        className="flex items-center justify-center w-20 h-20 bg-primary text-primary-foreground rounded-2xl mb-4 shadow-lg transition-all duration-500 hover:rotate-[-10deg] hover:scale-[1.05]"
      >
