...
const AccessibleModal = React.forwardRef<HTMLDivElement, AccessibleModalProps>(({
  ...
  const { announceToScreenReader: _announceToScreenReader, preferences } = useAccessibility()
  ...
  React.useEffect(() => {
    if (open) {
      ...
      if (announceOnOpen) {
        ...
        setTimeout(() => {
          _announceToScreenReader(announceOnOpen, 'assertive')
        }, 100)
      }
    } else {
      onClose?.()
      if (announceOnClose) {
        _announceToScreenReader(announceOnClose)
      }
    }
  }, [open, onOpen, onClose, announceOnOpen, announceOnClose, _announceToScreenReader])
      ...
      <div className="space-y-4">
        ...
        <DialogFooter>
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-[hsl(var(--foreground))] bg-[hsl(var(--card))] border-[hsl(var(--border))] rounded-md hover:bg-[hsl(var(--accent)/0.03)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[hsl(var(--ring))]"
          >
            {cancelText}
          </button>
          <button
            ...
            className={cn(
              "px-4 py-2 text-sm font-medium text-[hsl(var(--primary-foreground))] rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2",
              variant === 'destructive' 
                ? "bg-[hsl(var(--destructive))] hover:bg-[hsl(var(--destructive)/0.9)] focus:ring-[hsl(var(--destructive))]"
                : "bg-[hsl(var(--accent))] hover:bg-[hsl(var(--accent)/0.9)] focus:ring-[hsl(var(--accent))] text-[hsl(var(--accent-foreground))]"
            )}
          >
            {confirmText}
          </button>
      ...
      <div className="space-y-4">
        ...
        <DialogFooter>
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-[hsl(var(--accent-foreground))] bg-[hsl(var(--accent))] rounded-md hover:bg-[hsl(var(--accent)/0.9)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[hsl(var(--accent))]"
          >
            {acknowledgeText}
          </button>
        </DialogFooter>
