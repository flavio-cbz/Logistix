    ...
    <div className="p-8 space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="h-16 bg-[hsl(var(--card))] rounded shadow-enhanced-sm flex items-center justify-center">
            <span className="typography-small">Small</span>
          </div>
          <div className="h-16 bg-[hsl(var(--card))] rounded shadow-enhanced-md flex items-center justify-center">
            <span className="typography-small">Medium</span>
          </div>
          <div className="h-16 bg-[hsl(var(--card))] rounded shadow-enhanced-lg flex items-center justify-center">
            <span className="typography-small">Large</span>
          </div>
          <div className="h-16 bg-[hsl(var(--card))] rounded shadow-enhanced-xl flex items-center justify-center">
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="h-16 bg-gradient-primary rounded flex items-center justify-center">
            <span className="typography-small text-[hsl(var(--primary-foreground))] bg-[hsl(var(--glass-bg))]">Primary</span>
          </div>
          <div className="h-16 bg-gradient-success rounded flex items-center justify-center">
            <span className="typography-small text-[hsl(var(--primary-foreground))] bg-[hsl(var(--glass-bg))]">Success</span>
          </div>
          <div className="h-16 bg-gradient-warning rounded flex items-center justify-center">
            <span className="typography-small text-[hsl(var(--primary-foreground))] bg-[hsl(var(--glass-bg))]">Warning</span>
          </div>
          <div className="h-16 bg-gradient-info rounded flex items-center justify-center">
            <span className="typography-small text-[hsl(var(--primary-foreground))] bg-[hsl(var(--glass-bg))]">Info</span>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="relative h-32 bg-gradient-primary rounded-lg overflow-hidden">
          <div className="absolute inset-4 text-[hsl(var(--primary-foreground))] bg-[hsl(var(--glass-bg))] rounded-lg flex items-center justify-center">
            <span className="typography-body text-[hsl(var(--primary-foreground))] bg-[hsl(var(--glass-bg))]">Glass Effect</span>
          </div>
        </div>
      </section>
