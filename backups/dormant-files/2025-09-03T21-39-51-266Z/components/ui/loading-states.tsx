            ...
            <div key={_index} className="flex items-center space-x-2">
              <div 
                className={cn(
                  ...
                  _index < currentStep ? "bg-success" : 
                  _index === currentStep ? "bg-primary animate-pulse" : 
                  "bg-muted"
                )}
                aria-hidden="true"
              />
              <span 
                className={cn(
                  ...
                  _index < currentStep ? "text-success" : 
                  _index === currentStep ? "text-foreground" : 
                  "text-muted-foreground"
                )}
                aria-current={_index === currentStep ? "step" : undefined}
              >
                {step}
              </span>
            </div>
