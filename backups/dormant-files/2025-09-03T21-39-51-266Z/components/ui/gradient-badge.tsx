  ...
  "inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-medium transition-all duration-300 ease-out focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        premium: "bg-gradient-to-r from-purple-500 to-pink-500 text-[hsl(var(--primary-foreground))] shadow-sm hover:shadow-md",
        new: "bg-gradient-to-r from-blue-500 to-cyan-500 text-[hsl(var(--primary-foreground))] shadow-sm hover:shadow-md animate-shimmer",
      },
      size: {
