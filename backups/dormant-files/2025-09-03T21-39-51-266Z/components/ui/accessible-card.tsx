    ...
    const combinedRef = React.useCallback((node: HTMLDivElement) => {
      ...
      if (ref) {
        if (typeof ref === 'function') {
          ...
          // `ref` can be a RefObject which has a readonly `current` in the React typings.
          // Cast to MutableRefObject locally to allow assignment — this is safe here
          // because the forwarded ref originates from useRef in callers.
