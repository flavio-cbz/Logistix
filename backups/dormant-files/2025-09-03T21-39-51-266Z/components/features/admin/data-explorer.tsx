    ...
    <Card className="w-full">
      ...
      <CardContent>
        <Tabs defaultValue={activeTable} onValueChange={handleTableChange}>
          ...
          {showFilters && (
            <div
              className="mb-4 p-4 border rounded-md transition-all duration-300 ease-in-out"
                        ...
                        <TableRow key={record.id}>
                          ...
                          {getColumns().map((column) => (
                            <TableCell key={column}>
                              {typeof (record as any)[column] === "boolean"
                                ? record[column]
                                  ? "Oui"
                                  : "Non"
                                  ...
                                  <div className="grid gap-4 py-4 max-h-[60vh] overflow-y-auto">
                                    {getColumns().map((column) => (
                                      <div key={column} className="grid grid-cols-4 items-center gap-4">
                                        ...
                                        {typeof (editRecord as any)[column] === "boolean" ? (
