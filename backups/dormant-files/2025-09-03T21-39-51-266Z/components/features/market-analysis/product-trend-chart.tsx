...
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, Bar } from 'recharts'; // Removed BarChart
import React from 'react'; // Keep React import if JSX is used directly
      ...
      <CardContent>
        <ResponsiveContainer width="100%" height={350}>
          <LineChart data={formattedData}>
            ...
            <Tooltip />
            <Legend />
            <Line yAxisId="left" type="monotone" dataKey="avgPrice" stroke="hsl(var(--primary))" name="Prix moyen" dot={false} />
            <Bar yAxisId="right" dataKey="salesVolume" fill="hsl(var(--success))" name="Volume de ventes" barSize={18} />
          </LineChart>
        </ResponsiveContainer>
      </CardContent>
    </Card>
