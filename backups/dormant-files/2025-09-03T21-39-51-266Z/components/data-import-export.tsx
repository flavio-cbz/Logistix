...
export function DataImportExport() {
  ...
  const handleExport = () => {
    try {
      ...
      const jsonData = JSON.stringify(data, null, 2) // Correction: _data en data
      ...
      toast({
        ...
        description: "Vos données et configurations ont été exportées avec succès.", // Correction: _description en description
      })
    } catch (error) {
      ...
      toast({
        ...
        description: "Une erreur est survenue lors de l'exportation des données.", // Correction: _description en description
      })
    }
  }
  ...
  const handleImport = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        importData(data) // Correction: _data en data
 
        toast({
          title: "Importation réussie",
          description: "Vos données et configurations ont été importées avec succès.", // Correction: _description en description
        })
        ...
        toast({
          ...
          description: "Le fichier sélectionné n'est pas valide.", // Correction: _description en description
        })
      }
    }
