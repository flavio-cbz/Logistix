...
import type { EnhancedChart } from '@/lib/services/ai/enhanced-visualization-engine'
import { 
  Download, 
  FileImage, 
  FileText, 
...
export const ChartExportUtility: React.FC<ChartExportUtilityProps> = ({
  ...
  const renderExportTab = () => (
    <div className="space-y-6">
            ...
            return (
              <Card
                ...
                className={cn(
                  ...
                  isSelected && 'ring-2 ring-blue-500 bg-[hsl(var(--primary))] dark:bg-[hsl(var(--primary))]-950'
                )}
              ...
              >
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    <Icon className={cn(
                      'h-5 w-5 mt-0.5',
                      isSelected ? 'text-[hsl(var(--primary-foreground))]' : 'text-[hsl(var(--muted-foreground))]'
                    )} />
              ...
              {qualityOptions.map((option) => (
                <SelectItem key={option.value} value={option.value}>
                  <div>
                    ...
                    <div className="text-sm text-[hsl(var(--muted-foreground))]">{option.description}</div>
                  </div>
                </SelectItem>
              ))}
            </SelectContent>
      ...
      <Card className="bg-[hsl(var(--muted))] dark:bg-[hsl(var(--muted))]">
        <CardContent className="p-4">
      ...
      <div className="space-y-3">
        ...
        {exportStatus === 'success' && (
          <div className="flex items-center gap-2 text-[hsl(var(--success-foreground))] text-sm">
        ...
        {exportStatus === 'error' && (
          <div className="flex items-center gap-2 text-[hsl(var(--destructive-foreground))] text-sm">
        ...
        <div className="space-y-2">
          {shareOptions.map((option) => (
            <Card
              ...
              className={cn(
                'cursor-pointer transition-all hover:shadow-md',
                shareConfig.platform === option.value && 'ring-2 ring-blue-500 bg-[hsl(var(--primary))] dark:bg-[hsl(var(--primary))]-950'
              )}
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  {shareConfig.platform === option.value && (
                    <Check className="h-5 w-5 text-[hsl(var(--primary-foreground))]" />
                  )}
                </div>
              </CardContent>
            </Card>
        ...
        <div className="flex border-b">
          <button
            ...
            className={cn(
              ...
              activeTab === 'export' 
                ? 'border-[hsl(var(--border))] text-[hsl(var(--primary-foreground))]' 
                : 'border-transparent text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--muted-foreground))]'
            )}
          >
            Export
          </button>
