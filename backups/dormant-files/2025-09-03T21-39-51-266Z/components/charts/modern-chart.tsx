...
// import { easeOut } from 'framer-motion' // Removed framer-motion import
...
export const ModernChart: React.FC<ModernChartProps> = ({
  ...
  const chartConfig = React.useMemo(() => {
    ...
    return keys.reduce<Record<string, { label: string; color: string }>>((config, key, index) => {
      config[key] = {
  ...
  const customTooltipFormatter = (value: unknown, name: string | number) => [
