...
describe('Erreurs personnalisées', () => {
  ...
  describe('Aliases d\'erreurs', () => {
    ...
    it('RequestValidationError devrait être un alias de ValidationError', () => {
      expect(RequestValidationError).toBe(ValidationError);
      
      const error = new RequestValidationError('Request invalid');
